...
void VulkanContext::CreateInstance(const char* title)
{
	...
	auto extensions = GetRequiredExtensions(); // returns a required list of extensions based
											   // on whether validation layers are enabled or
											   // not
	...
	VkDebugUtilsMessengerEXT* pDebugMessenger)
{
	...
	auto func = (PFN_vkCreateDebugUtilsMessengerEXT)vkGetInstanceProcAddr(instance,
		"vkCreateDebugUtilsMessengerEXT"); // returns nullptr if the
